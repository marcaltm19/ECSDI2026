...
def comunicacion():
    ...
    if not message:
        return ('<html><head><title>AgenteTransportista</title></head>'
                '<body style="font-family:sans-serif;padding:32px"><h2>AgenteTransportista — ' + NOMBRE + '</h2>'
    ...
    try:
        ...
        logger.warning(f'[Transportista] /comm parse error: {e}')
        mss_cnt += 1
